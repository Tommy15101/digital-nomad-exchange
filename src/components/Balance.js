...
const Balance = () => {
    ...
    return (
      <div className='component exchange__transfers'>
        ...
        {/* Deposit/Withdraw Component 1 (Digital Nomad Token) */}
        ...
        <div className='exchange__transfers--form'>
          ...
          <form onSubmit={isDeposit ? (e) => depositHander(e, tokens[0]) : (e) => withdrawHandler(e, tokens[0])}>
        ...
        {/* Deposit/Withdraw Component 2 (Phuket Token) */}
        ...
        <div className='exchange__transfers--form'>
          ...
          <form onSubmit={isDeposit ? (e) => depositHander(e, tokens[1]) : (e) => withdrawHandler(e, tokens[1])}>
